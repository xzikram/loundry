            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white/95 backdrop-blur-xl py-8 px-4 border border-white/20 shadow-2xl shadow-black/20 sm:rounded-2xl sm:px-10">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('auth.google') }}" target="_blank" rel="noopener noreferrer" class="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-[#E2E7EF] rounded-xl shadow-sm text-sm font-semibold text-[#4A5568] bg-[#F8F9FC] hover:bg-slate-50 hover:border-[#1E3A5F]/20 transition-all cursor-pointer">
