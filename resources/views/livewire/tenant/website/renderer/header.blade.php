...
<header x-data="{ mobileMenuOpen: false }" class="bg-[var(--color-surface)]/90 backdrop-blur-md border-b border-[#E2E7EF]/60 sticky top-0 z-40 transition-all duration-300">
    <div class="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center space-x-8 text-xs font-bold uppercase tracking-wider">
            ...
            <a href="#location" class="px-5 py-2.5 text-[11px] font-extrabold text-white tracking-widest uppercase hover:opacity-90 shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" style="background-color: var(--color-primary); border-radius: var(--border-radius);">
                Hubungi Kami
            </a>
        </nav>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="pt-3">
            <a href="#location" class="block text-center px-4 py-3 text-xs font-bold text-white shadow-md" style="background-color: var(--color-primary); border-radius: var(--border-radius);">
                Hubungi Kami
            </a>
        </div>
    </div>
